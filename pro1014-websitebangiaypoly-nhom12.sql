...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 12, 2023 lúc 09:16 AM
...
INSERT INTO `sanpham` (`IdSanPham`, `TenSanPham`, `Gia`, `img`, `MoTa`, `SoLuong`, `luotxem`, `iddm`, `trangThai`) VALUES
...
--
ALTER TABLE `chitietdonhang`
  MODIFY `IdChiTietDonHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `donhang`
  MODIFY `IdDonHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6241;
...
--
ALTER TABLE `giohang`
  MODIFY `IdGioHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
