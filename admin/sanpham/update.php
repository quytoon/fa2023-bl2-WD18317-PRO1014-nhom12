...
<div class="card mb-4">
    ...
    <form action="index.php?act=updatesp" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="anhsp" class="form-label">Ảnh đại diện <i class="bi bi-image"></i></label> <br>
            <input type="file" class="form-control" id="" name="anhsp">
            <?= $hinh ?>
        </div>
        <div class="mb-3">
            <label for="thuvienanh" class="form-label">Thư viện ảnh <i class="bi bi-image"></i></label> <br>
            <input type="file" class="form-control" id="" name="thuvienanh[]" multiple>
            <div class='d-flex'>
                <?php
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="" name="soluong" placeholder="Nhập số lượng"
                value="<?= $SoLuong ?>">
        </div>
        <div class="mb-3">
