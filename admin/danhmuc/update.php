...
<body>
    <div class="container d-flex align-items-center justify-content-center vh-100">
        <div class="row">
            <div class="col-12">
                <div class="mb-4">
                    <h1 class="font_title">EDIT DANH MỤC</h1>
                </div>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="tensp" class="form-label">Mã Danh Mục  <i class="bi bi-person"></i></label> <br>
                        <input type="text" class="form-control" id="" name="" placeholder="Nhập vào mã danh mục ">
                    </div>
                    <div class="mb-3">
                        <label for="giasp" class="form-label">Tên Danh Mục  <i class="bi bi-cash"></i></label> <br>
                        <input type="text" class="form-control" id="" name="" placeholder="Nhập vào tên danh mục ">
                    </div>
          <div class="mb-3">
